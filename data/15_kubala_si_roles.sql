...
LOCK TABLES `si_roles` WRITE;
/*!40000 ALTER TABLE `si_roles` DISABLE KEYS */;
INSERT INTO `si_roles` VALUES (1,'ROLE_ADMIN'),(2,'ROLE_USER');
/*!40000 ALTER TABLE `si_roles` ENABLE KEYS */;
UNLOCK TABLES;
